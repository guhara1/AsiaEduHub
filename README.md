...
Cloudflare Pages 자동 배포. 첫 연결·도메인·환경 변수 단계별 가이드는 [`docs/DEPLOY.md`](./docs/DEPLOY.md) 참고.

- 빌드 명령: `npm run build`
- 출력 디렉터리: `dist`
- Node: `20` (`.node-version` 기준)
- 환경 변수: `SITE_URL` (기본 `https://asiaeduhub.com`. 미리보기는 `asiaeduhub.pages.dev` 사용 시 별도 지정)
